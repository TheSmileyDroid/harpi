...
function GuildList({ className = "" }: { className?: string }) {
  ...
  return (
    ...
    >
      <h2 className="text-lg mb-6 opacity-80 tracking-wider text-center">GUILDAS</h2>
          ...
          >
            ...
            >
              <Button
                ...
                size={"lg"}
                className={clsx(
                  "victorian-border shadow-[0_0_8px_rgba(0,0,0,0.2)] h-fit flex flex-col w-full transition-all duration-300 text-xs",
                  {
              ...
              >
                ...
                {guild.description && (
                  <span className="opacity-70">{guild.description}</span>
                )}
                <span className="m-1 opacity-80">
