...
class TuningTask(proto.Message):
    ...
    complete_time: timestamp_pb2.Timestamp = ...
    snapshots: MutableSequence[TuningSnapshot] = ...
...
class TuningExamples(proto.Message):
    ...
    Attributes:
        examples (MutableSequence[google.ai.generativelanguage_v1beta.types.TuningExample]):
            ...
            the same type.
    """
    examples: MutableSequence[TuningExample] = ...
...
class TuningSnapshot(proto.Message):
    ...
    epoch: int = ...
    mean_loss: float = ...
    compute_time: timestamp_pb2.Timestamp = ...
