...
from google.ai.generativelanguage_v1beta.types import citation, content as gag_content, retriever, safety
...
class GenerateContentRequest(proto.Message):
    ...
    """
    model: str = ...
    system_instruction: gag_content.Content = ...
    contents: MutableSequence[gag_content.Content] = ...
    tools: MutableSequence[gag_content.Tool] = ...
    tool_config: gag_content.ToolConfig = ...
    safety_settings: MutableSequence[safety.SafetySetting] = ...
...
class GenerationConfig(proto.Message):
    ...
    top_k: int = ...
    response_mime_type: str = ...
    response_schema: gag_content.Schema = ...
    presence_penalty: float = ...
    frequency_penalty: float = ...
    response_logprobs: bool = ...
    logprobs: int = ...
    enable_enhanced_civic_answers: bool = ...
    response_modalities: MutableSequence[Modality] = ...
...
class GenerateContentResponse(proto.Message):
    ...
    class PromptFeedback(proto.Message):
        ...
        safety_ratings: MutableSequence[safety.SafetyRating] = ...
...
class Candidate(proto.Message):
    ...
    index: int = ...
    content: gag_content.Content = ...
    finish_reason: FinishReason = ...
    safety_ratings: MutableSequence[safety.SafetyRating] = ...
    citation_metadata: citation.CitationMetadata = ...
    token_count: int = ...
    ...
    class TopCandidates(proto.Message):
        ...
        Attributes:
            candidates (MutableSequence[google.ai.generativelanguage_v1beta.types.LogprobsResult.Candidate]):
                ...
                order.
        """
        candidates: MutableSequence[LogprobsResult.Candidate] = ...
    
    
    top_candidates: MutableSequence[TopCandidates] = ...
    chosen_candidates: MutableSequence[Candidate] = ...
...
class GroundingMetadata(proto.Message):
    ...
    grounding_chunks: MutableSequence[GroundingChunk] = ...
    grounding_supports: MutableSequence[GroundingSupport] = ...
...
class BatchEmbedContentsRequest(proto.Message):
    ...
    """
    model: str = ...
    requests: MutableSequence[EmbedContentRequest] = ...
...
class BatchEmbedContentsResponse(proto.Message):
    ...
    Attributes:
        embeddings (MutableSequence[google.ai.generativelanguage_v1beta.types.ContentEmbedding]):
            ...
            request.
    """
    embeddings: MutableSequence[ContentEmbedding] = ...
