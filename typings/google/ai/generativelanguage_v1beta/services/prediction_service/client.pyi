...
class PredictionServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry: Dict[str, Type[PredictionServiceTransport]] = ...
    def get_transport_class(cls, label: Optional[str] = ...) -> Type[PredictionServiceTransport]:
...
class PredictionServiceClient(metaclass=PredictionServiceClientMeta):
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials] = ..., transport: Optional[Union[str, PredictionServiceTransport, Callable[..., PredictionServiceTransport],]] = ..., client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = ..., client_info: gapic_v1.client_info.ClientInfo = ...) -> None:
    ...
    def predict(self, request: Optional[Union[prediction_service.PredictRequest, dict]] = ..., *, model: Optional[str] = ..., instances: Optional[MutableSequence[struct_pb2.Value]] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> prediction_service.PredictResponse:
