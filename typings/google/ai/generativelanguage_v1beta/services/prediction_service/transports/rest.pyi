...
class PredictionServiceRestTransport(_BasePredictionServiceRestTransport):
    ...
    class _Predict(_BasePredictionServiceRestTransport._BasePredict, PredictionServiceRestStub):
        ...
        def __call__(self, request: prediction_service.PredictRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> prediction_service.PredictResponse:
