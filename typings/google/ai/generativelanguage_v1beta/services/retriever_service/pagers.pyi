...
class ListCorporaPager:
    ...
    """
    def __init__(self, method: Callable[..., retriever_service.ListCorporaResponse], request: retriever_service.ListCorporaRequest, response: retriever_service.ListCorporaResponse, *, retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
...
class ListCorporaAsyncPager:
    ...
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self, method: Callable[..., Awaitable[retriever_service.ListCorporaResponse]], request: retriever_service.ListCorporaRequest, response: retriever_service.ListCorporaResponse, *, retry: OptionalAsyncRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
...
class ListDocumentsPager:
    ...
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self, method: Callable[..., retriever_service.ListDocumentsResponse], request: retriever_service.ListDocumentsRequest, response: retriever_service.ListDocumentsResponse, *, retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
        """Instantiate the pager.
...
class ListDocumentsAsyncPager:
    ...
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self, method: Callable[..., Awaitable[retriever_service.ListDocumentsResponse]], request: retriever_service.ListDocumentsRequest, response: retriever_service.ListDocumentsResponse, *, retry: OptionalAsyncRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
        """Instantiates the pager.
...
class ListChunksPager:
    ...
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self, method: Callable[..., retriever_service.ListChunksResponse], request: retriever_service.ListChunksRequest, response: retriever_service.ListChunksResponse, *, retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
        """Instantiate the pager.
...
class ListChunksAsyncPager:
    ...
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self, method: Callable[..., Awaitable[retriever_service.ListChunksResponse]], request: retriever_service.ListChunksRequest, response: retriever_service.ListChunksResponse, *, retry: OptionalAsyncRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
        """Instantiates the pager.
