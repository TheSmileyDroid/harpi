...
class RetrieverServiceRestTransport(_BaseRetrieverServiceRestTransport):
    ...
    class _BatchCreateChunks(_BaseRetrieverServiceRestTransport._BaseBatchCreateChunks, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.BatchCreateChunksRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> retriever_service.BatchCreateChunksResponse:
    ...
    class _BatchDeleteChunks(_BaseRetrieverServiceRestTransport._BaseBatchDeleteChunks, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.BatchDeleteChunksRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...): # -> None:
    ...
    class _BatchUpdateChunks(_BaseRetrieverServiceRestTransport._BaseBatchUpdateChunks, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.BatchUpdateChunksRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> retriever_service.BatchUpdateChunksResponse:
    ...
    class _CreateChunk(_BaseRetrieverServiceRestTransport._BaseCreateChunk, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.CreateChunkRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> retriever.Chunk:
    ...
    class _CreateCorpus(_BaseRetrieverServiceRestTransport._BaseCreateCorpus, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.CreateCorpusRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> retriever.Corpus:
    ...
    class _CreateDocument(_BaseRetrieverServiceRestTransport._BaseCreateDocument, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.CreateDocumentRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> retriever.Document:
    ...
    class _DeleteChunk(_BaseRetrieverServiceRestTransport._BaseDeleteChunk, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.DeleteChunkRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...): # -> None:
    ...
    class _DeleteCorpus(_BaseRetrieverServiceRestTransport._BaseDeleteCorpus, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.DeleteCorpusRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...): # -> None:
    ...
    class _DeleteDocument(_BaseRetrieverServiceRestTransport._BaseDeleteDocument, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.DeleteDocumentRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...): # -> None:
    ...
    class _GetChunk(_BaseRetrieverServiceRestTransport._BaseGetChunk, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.GetChunkRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> retriever.Chunk:
    ...
    class _GetCorpus(_BaseRetrieverServiceRestTransport._BaseGetCorpus, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.GetCorpusRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> retriever.Corpus:
    ...
    class _GetDocument(_BaseRetrieverServiceRestTransport._BaseGetDocument, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.GetDocumentRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> retriever.Document:
    ...
    class _ListChunks(_BaseRetrieverServiceRestTransport._BaseListChunks, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.ListChunksRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> retriever_service.ListChunksResponse:
    ...
    class _ListCorpora(_BaseRetrieverServiceRestTransport._BaseListCorpora, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.ListCorporaRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> retriever_service.ListCorporaResponse:
    ...
    class _ListDocuments(_BaseRetrieverServiceRestTransport._BaseListDocuments, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.ListDocumentsRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> retriever_service.ListDocumentsResponse:
    ...
    class _QueryCorpus(_BaseRetrieverServiceRestTransport._BaseQueryCorpus, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.QueryCorpusRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> retriever_service.QueryCorpusResponse:
    ...
    class _QueryDocument(_BaseRetrieverServiceRestTransport._BaseQueryDocument, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.QueryDocumentRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> retriever_service.QueryDocumentResponse:
    ...
    class _UpdateChunk(_BaseRetrieverServiceRestTransport._BaseUpdateChunk, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.UpdateChunkRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> retriever.Chunk:
    ...
    class _UpdateCorpus(_BaseRetrieverServiceRestTransport._BaseUpdateCorpus, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.UpdateCorpusRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> retriever.Corpus:
    ...
    class _UpdateDocument(_BaseRetrieverServiceRestTransport._BaseUpdateDocument, RetrieverServiceRestStub):
        ...
        def __call__(self, request: retriever_service.UpdateDocumentRequest, *, retry: OptionalRetry = ..., timeout: Optional[float] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> retriever.Document:
