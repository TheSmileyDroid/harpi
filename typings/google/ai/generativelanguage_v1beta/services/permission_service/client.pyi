...
class PermissionServiceClient(metaclass=PermissionServiceClientMeta):
    ...
    def create_permission(self, request: Optional[Union[permission_service.CreatePermissionRequest, dict]] = ..., *, parent: Optional[str] = ..., permission: Optional[gag_permission.Permission] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> gag_permission.Permission:
    ...
    def get_permission(self, request: Optional[Union[permission_service.GetPermissionRequest, dict]] = ..., *, name: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> permission.Permission:
    ...
    def list_permissions(self, request: Optional[Union[permission_service.ListPermissionsRequest, dict]] = ..., *, parent: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> pagers.ListPermissionsPager:
    ...
    def delete_permission(self, request: Optional[Union[permission_service.DeletePermissionRequest, dict]] = ..., *, name: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
    ...
    def transfer_ownership(self, request: Optional[Union[permission_service.TransferOwnershipRequest, dict]] = ..., *, retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> permission_service.TransferOwnershipResponse:
