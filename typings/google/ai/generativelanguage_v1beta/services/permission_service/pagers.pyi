...
class ListPermissionsPager:
    ...
    """
    def __init__(self, method: Callable[..., permission_service.ListPermissionsResponse], request: permission_service.ListPermissionsRequest, response: permission_service.ListPermissionsResponse, *, retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
...
class ListPermissionsAsyncPager:
    ...
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self, method: Callable[..., Awaitable[permission_service.ListPermissionsResponse]], request: permission_service.ListPermissionsRequest, response: permission_service.ListPermissionsResponse, *, retry: OptionalAsyncRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
