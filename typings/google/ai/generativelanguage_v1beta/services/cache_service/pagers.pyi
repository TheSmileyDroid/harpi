...
class ListCachedContentsPager:
    ...
    """
    def __init__(self, method: Callable[..., cache_service.ListCachedContentsResponse], request: cache_service.ListCachedContentsRequest, response: cache_service.ListCachedContentsResponse, *, retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
...
class ListCachedContentsAsyncPager:
    ...
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self, method: Callable[..., Awaitable[cache_service.ListCachedContentsResponse]], request: cache_service.ListCachedContentsRequest, response: cache_service.ListCachedContentsResponse, *, retry: OptionalAsyncRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
