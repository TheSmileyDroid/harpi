...
class CacheServiceClient(metaclass=CacheServiceClientMeta):
    ...
    def list_cached_contents(self, request: Optional[Union[cache_service.ListCachedContentsRequest, dict]] = ..., *, retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> pagers.ListCachedContentsPager:
    ...
    def create_cached_content(self, request: Optional[Union[cache_service.CreateCachedContentRequest, dict]] = ..., *, cached_content: Optional[gag_cached_content.CachedContent] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> gag_cached_content.CachedContent:
    ...
    def get_cached_content(self, request: Optional[Union[cache_service.GetCachedContentRequest, dict]] = ..., *, name: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> cached_content.CachedContent:
    ...
    def update_cached_content(self, request: Optional[Union[cache_service.UpdateCachedContentRequest, dict]] = ..., *, cached_content: Optional[gag_cached_content.CachedContent] = ..., update_mask: Optional[field_mask_pb2.FieldMask] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> gag_cached_content.CachedContent:
    ...
    def delete_cached_content(self, request: Optional[Union[cache_service.DeleteCachedContentRequest, dict]] = ..., *, name: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
