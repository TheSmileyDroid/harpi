...
class ModelServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry: Dict[str, Type[ModelServiceTransport]] = ...
    def get_transport_class(cls, label: Optional[str] = ...) -> Type[ModelServiceTransport]:
...
class ModelServiceClient(metaclass=ModelServiceClientMeta):
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials] = ..., transport: Optional[Union[str, ModelServiceTransport, Callable[..., ModelServiceTransport]]] = ..., client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = ..., client_info: gapic_v1.client_info.ClientInfo = ...) -> None:
    ...
    def get_model(self, request: Optional[Union[model_service.GetModelRequest, dict]] = ..., *, name: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> model.Model:
    ...
    def list_models(self, request: Optional[Union[model_service.ListModelsRequest, dict]] = ..., *, page_size: Optional[int] = ..., page_token: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> pagers.ListModelsPager:
        r"""Lists the
    ...
    def get_tuned_model(self, request: Optional[Union[model_service.GetTunedModelRequest, dict]] = ..., *, name: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> tuned_model.TunedModel:
    ...
    def list_tuned_models(self, request: Optional[Union[model_service.ListTunedModelsRequest, dict]] = ..., *, page_size: Optional[int] = ..., page_token: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> pagers.ListTunedModelsPager:
    ...
    def create_tuned_model(self, request: Optional[Union[model_service.CreateTunedModelRequest, dict]] = ..., *, tuned_model: Optional[gag_tuned_model.TunedModel] = ..., tuned_model_id: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> operation.Operation:
    ...
    def update_tuned_model(self, request: Optional[Union[model_service.UpdateTunedModelRequest, dict]] = ..., *, tuned_model: Optional[gag_tuned_model.TunedModel] = ..., update_mask: Optional[field_mask_pb2.FieldMask] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> gag_tuned_model.TunedModel:
    ...
    def delete_tuned_model(self, request: Optional[Union[model_service.DeleteTunedModelRequest, dict]] = ..., *, name: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
