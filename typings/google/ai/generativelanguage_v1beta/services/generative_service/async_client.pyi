...
from typing import AsyncIterable, Awaitable, Callable, MutableSequence, Optional, Sequence, Tuple, Union
...
class GenerativeServiceAsyncClient:
    ...
    get_transport_class = ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials] = ..., transport: Optional[Union[str, GenerativeServiceTransport, Callable[..., GenerativeServiceTransport],]] = ..., client_options: Optional[ClientOptions] = ..., client_info: gapic_v1.client_info.ClientInfo = ...) -> None:
    ...
    async def generate_content(self, request: Optional[Union[generative_service.GenerateContentRequest, dict]] = ..., *, model: Optional[str] = ..., contents: Optional[MutableSequence[content.Content]] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> generative_service.GenerateContentResponse:
    ...
    async def embed_content(self, request: Optional[Union[generative_service.EmbedContentRequest, dict]] = ..., *, model: Optional[str] = ..., content: Optional[gag_content.Content] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> generative_service.EmbedContentResponse:
    ...
    async def count_tokens(self, request: Optional[Union[generative_service.CountTokensRequest, dict]] = ..., *, model: Optional[str] = ..., contents: Optional[MutableSequence[content.Content]] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> generative_service.CountTokensResponse:
