...
from typing import Callable, Dict, Iterable, MutableSequence, Optional, Sequence, Tuple, Type, Union
from google.api_core import client_options as client_options_lib, gapic_v1
from google.auth import credentials as ga_credentials
from google.longrunning import operations_pb2
from google.ai.generativelanguage_v1beta.types import content, generative_service, safety
...
class GenerativeServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry: Dict[str, Type[GenerativeServiceTransport]] = ...
    def get_transport_class(cls, label: Optional[str] = ...) -> Type[GenerativeServiceTransport]:
...
class GenerativeServiceClient(metaclass=GenerativeServiceClientMeta):
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials] = ..., transport: Optional[Union[str, GenerativeServiceTransport, Callable[..., GenerativeServiceTransport],]] = ..., client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = ..., client_info: gapic_v1.client_info.ClientInfo = ...) -> None:
    ...
    def generate_content(self, request: Optional[Union[generative_service.GenerateContentRequest, dict]] = ..., *, model: Optional[str] = ..., contents: Optional[MutableSequence[content.Content]] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> generative_service.GenerateContentResponse:
    ...
    def generate_answer(self, request: Optional[Union[generative_service.GenerateAnswerRequest, dict]] = ..., *, model: Optional[str] = ..., contents: Optional[MutableSequence[content.Content]] = ..., safety_settings: Optional[MutableSequence[safety.SafetySetting]] = ..., answer_style: Optional[generative_service.GenerateAnswerRequest.AnswerStyle] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> generative_service.GenerateAnswerResponse:
    ...
    def stream_generate_content(self, request: Optional[Union[generative_service.GenerateContentRequest, dict]] = ..., *, model: Optional[str] = ..., contents: Optional[MutableSequence[content.Content]] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> Iterable[generative_service.GenerateContentResponse]:
    ...
    def embed_content(self, request: Optional[Union[generative_service.EmbedContentRequest, dict]] = ..., *, model: Optional[str] = ..., content: Optional[gag_content.Content] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> generative_service.EmbedContentResponse:
    ...
    def batch_embed_contents(self, request: Optional[Union[generative_service.BatchEmbedContentsRequest, dict]] = ..., *, model: Optional[str] = ..., requests: Optional[MutableSequence[generative_service.EmbedContentRequest]] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> generative_service.BatchEmbedContentsResponse:
    ...
    def count_tokens(self, request: Optional[Union[generative_service.CountTokensRequest, dict]] = ..., *, model: Optional[str] = ..., contents: Optional[MutableSequence[content.Content]] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> generative_service.CountTokensResponse:
