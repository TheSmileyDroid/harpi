...
class FileServiceClient(metaclass=FileServiceClientMeta):
    ...
    def create_file(self, request: Optional[Union[file_service.CreateFileRequest, dict]] = ..., *, retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> file_service.CreateFileResponse:
        r"""Creates a ``File``.
    ...
    def list_files(self, request: Optional[Union[file_service.ListFilesRequest, dict]] = ..., *, retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> pagers.ListFilesPager:
    ...
    def get_file(self, request: Optional[Union[file_service.GetFileRequest, dict]] = ..., *, name: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> file.File:
    ...
    def delete_file(self, request: Optional[Union[file_service.DeleteFileRequest, dict]] = ..., *, name: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
        r"""Deletes the ``File``.
