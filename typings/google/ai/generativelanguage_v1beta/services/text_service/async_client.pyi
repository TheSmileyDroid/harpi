...
class TextServiceAsyncClient:
    ...
    async def generate_text(self, request: Optional[Union[text_service.GenerateTextRequest, dict]] = ..., *, model: Optional[str] = ..., prompt: Optional[text_service.TextPrompt] = ..., temperature: Optional[float] = ..., candidate_count: Optional[int] = ..., max_output_tokens: Optional[int] = ..., top_p: Optional[float] = ..., top_k: Optional[int] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> text_service.GenerateTextResponse:
    ...
    async def embed_text(self, request: Optional[Union[text_service.EmbedTextRequest, dict]] = ..., *, model: Optional[str] = ..., text: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> text_service.EmbedTextResponse:
    ...
    async def batch_embed_text(self, request: Optional[Union[text_service.BatchEmbedTextRequest, dict]] = ..., *, model: Optional[str] = ..., texts: Optional[MutableSequence[str]] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> text_service.BatchEmbedTextResponse:
    ...
    async def count_text_tokens(self, request: Optional[Union[text_service.CountTextTokensRequest, dict]] = ..., *, model: Optional[str] = ..., prompt: Optional[text_service.TextPrompt] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> text_service.CountTextTokensResponse:
