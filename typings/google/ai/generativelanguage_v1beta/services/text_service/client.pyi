...
class TextServiceClient(metaclass=TextServiceClientMeta):
    ...
    def embed_text(self, request: Optional[Union[text_service.EmbedTextRequest, dict]] = ..., *, model: Optional[str] = ..., text: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> text_service.EmbedTextResponse:
    ...
    def batch_embed_text(self, request: Optional[Union[text_service.BatchEmbedTextRequest, dict]] = ..., *, model: Optional[str] = ..., texts: Optional[MutableSequence[str]] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> text_service.BatchEmbedTextResponse:
    ...
    def count_text_tokens(self, request: Optional[Union[text_service.CountTextTokensRequest, dict]] = ..., *, model: Optional[str] = ..., prompt: Optional[text_service.TextPrompt] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> text_service.CountTextTokensResponse:
