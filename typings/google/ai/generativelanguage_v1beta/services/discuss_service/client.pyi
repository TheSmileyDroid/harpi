...
class DiscussServiceClient(metaclass=DiscussServiceClientMeta):
    ...
    def generate_message(self, request: Optional[Union[discuss_service.GenerateMessageRequest, dict]] = ..., *, model: Optional[str] = ..., prompt: Optional[discuss_service.MessagePrompt] = ..., temperature: Optional[float] = ..., candidate_count: Optional[int] = ..., top_p: Optional[float] = ..., top_k: Optional[int] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> discuss_service.GenerateMessageResponse:
    ...
    def count_message_tokens(self, request: Optional[Union[discuss_service.CountMessageTokensRequest, dict]] = ..., *, model: Optional[str] = ..., prompt: Optional[discuss_service.MessagePrompt] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> discuss_service.CountMessageTokensResponse:
