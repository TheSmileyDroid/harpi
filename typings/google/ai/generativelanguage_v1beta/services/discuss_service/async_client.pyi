...
class DiscussServiceAsyncClient:
    ...
    async def count_message_tokens(self, request: Optional[Union[discuss_service.CountMessageTokensRequest, dict]] = ..., *, model: Optional[str] = ..., prompt: Optional[discuss_service.MessagePrompt] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> discuss_service.CountMessageTokensResponse:
