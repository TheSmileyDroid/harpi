...
def idecode_time(parent: dict[str, Any], name: str): # -> None:
    ...
...
def encode_tuning_example(example: TuningExampleOptions, input_key, output_key): # -> TuningExample:
    ...
...
def make_model_name(name: AnyModelNameOptions): # -> AnyModelNameOptions:
    ...
