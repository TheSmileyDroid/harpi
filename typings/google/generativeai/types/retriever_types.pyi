...
class Corpus:
    ...
    def update(self, updates: dict[str, Any], client: glm.RetrieverServiceClient | None = ..., request_options: helper_types.RequestOptionsType | None = ...): # -> Self:
        """
    ...
    async def update_async(self, updates: dict[str, Any], client: glm.RetrieverServiceAsyncClient | None = ..., request_options: helper_types.RequestOptionsType | None = ...): # -> Self:
    ...
    def delete_document(self, name: str, force: bool = ..., client: glm.RetrieverServiceClient | None = ..., request_options: helper_types.RequestOptionsType | None = ...): # -> None:
        """
    ...
    async def delete_document_async(self, name: str, force: bool = ..., client: glm.RetrieverServiceAsyncClient | None = ..., request_options: helper_types.RequestOptionsType | None = ...): # -> None:
...
def decode_document(document): # -> Document:
    ...
...
class Document(abc.ABC):
    ...
    def batch_create_chunks(self, chunks: BatchCreateChunkOptions, client: glm.RetrieverServiceClient | None = ..., request_options: helper_types.RequestOptionsType | None = ...): # -> list[Chunk]:
        """
    ...
    async def batch_create_chunks_async(self, chunks: BatchCreateChunkOptions, client: glm.RetrieverServiceAsyncClient | None = ..., request_options: helper_types.RequestOptionsType | None = ...): # -> list[Chunk]:
        """This is the async version of `Document.batch_create_chunk`."""
        ...
    
    def get_chunk(self, name: str, client: glm.RetrieverServiceClient | None = ..., request_options: helper_types.RequestOptionsType | None = ...): # -> Chunk:
        """
    ...
    async def get_chunk_async(self, name: str, client: glm.RetrieverServiceAsyncClient | None = ..., request_options: helper_types.RequestOptionsType | None = ...): # -> Chunk:
    ...
    def batch_update_chunks(self, chunks: BatchUpdateChunksOptions, client: glm.RetrieverServiceClient | None = ..., request_options: helper_types.RequestOptionsType | None = ...): # -> Dict[str, Any] | None:
        """
    ...
    async def batch_update_chunks_async(self, chunks: BatchUpdateChunksOptions, client: glm.RetrieverServiceAsyncClient | None = ..., request_options: helper_types.RequestOptionsType | None = ...): # -> Dict[str, Any] | None:
        """This is the async version of `Document.batch_update_chunks`."""
        ...
    
    def delete_chunk(self, name: str, client: glm.RetrieverServiceClient | None = ..., request_options: helper_types.RequestOptionsType | None = ...): # -> None:
        """
        Delete a `Chunk`.
    ...
    async def delete_chunk_async(self, name: str, client: glm.RetrieverServiceAsyncClient | None = ..., request_options: helper_types.RequestOptionsType | None = ...): # -> None:
        """This is the async version of `Document.delete_chunk`."""
        ...
    
    def batch_delete_chunks(self, chunks: BatchDeleteChunkOptions, client: glm.RetrieverServiceClient | None = ..., request_options: helper_types.RequestOptionsType | None = ...): # -> None:
        """
    ...
    async def batch_delete_chunks_async(self, chunks: BatchDeleteChunkOptions, client: glm.RetrieverServiceAsyncClient | None = ..., request_options: helper_types.RequestOptionsType | None = ...): # -> None:
