...
def is_blob_dict(d): # -> bool:
    ...

if typing.TYPE_CHECKING:
    BlobType = Union[protos.Blob, BlobDict, PIL.Image.Image]
else:
    ...
...
def is_part_dict(d): # -> bool:
    ...

def to_part(part: PartType): # -> Part:
    ...
...
def is_content_dict(d): # -> bool:
    ...

ContentType = protos.Content | ContentDict | PartType | Iterable[PartType]
StrictContentType = protos.Content | ContentDict
def to_content(content: ContentType) -> protos.Content:
    ...

def strict_to_content(content: StrictContentType): # -> Content:
    ...
...
def unpack_defs(schema, defs): # -> None:
    ...

def strip_titles(schema): # -> None:
    ...

def strip_additional_properties(schema): # -> None:
    ...

def add_object_type(schema): # -> None:
    ...

def convert_to_nullable(schema): # -> None:
    ...
...
class FunctionDeclaration:
    ...
    @staticmethod
    def from_function(function: Callable[..., Any], descriptions: dict[str, str] | None = ...): # -> CallableFunctionDeclaration:
