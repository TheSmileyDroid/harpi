...
def patch_colab_gce_credentials(): # -> Generator[None, Any, None]:
    ...
...
class _ClientManager:
    ...
    def make_client(self, name): # -> FileServiceAsyncClient | FileServiceClient | Any:
        ...

    def get_default_client(self, name): # -> OperationsClient | FileServiceAsyncClient | FileServiceClient | Any:
        ...
...
def configure(*, api_key: str | None = ..., credentials: ga_credentials.Credentials | None = ..., transport: str | None = ..., client_options: client_options_lib.ClientOptions | None = ..., client_info: gapic_v1.client_info.ClientInfo | None = ..., default_metadata: Sequence[tuple[str, str]] = ...) -> None:
