...
class CreateTunedModelOperation(operation_lib.Operation):
    @classmethod
    def from_proto(cls, proto, client): # -> CreateTunedModelOperation:
        """
    ...
    @classmethod
    def from_core_operation(cls, operation: operation_lib.Operation): # -> Self:
        ...
    ...
    def set_result(self, result: protos.TunedModel): # -> None:
        ...
