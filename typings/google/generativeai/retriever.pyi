...
def delete_corpus(name: str, force: bool = ..., client: glm.RetrieverServiceClient | None = ..., request_options: helper_types.RequestOptionsType | None = ...): # -> None:
...
async def delete_corpus_async(name: str, force: bool = ..., client: glm.RetrieverServiceAsyncClient | None = ..., request_options: helper_types.RequestOptionsType | None = ...): # -> None:
