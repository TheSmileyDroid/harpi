...
class OperationsAsyncClient:
    ...
    async def get_operation(self, name, retry=..., timeout=..., compression=..., metadata=...):
    ...
    async def list_operations(self, name, filter_, retry=..., timeout=..., compression=..., metadata=...): # -> AsyncGRPCIterator:
        """
    ...
    async def cancel_operation(self, name, retry=..., timeout=..., compression=..., metadata=...): # -> None:
    ...
    async def delete_operation(self, name, retry=..., timeout=..., compression=..., metadata=...): # -> None:
