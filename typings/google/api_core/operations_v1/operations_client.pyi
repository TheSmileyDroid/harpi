...
class OperationsClient:
    ...
    def list_operations(self, name, filter_, retry=..., timeout=..., compression=..., metadata=...): # -> GRPCIterator:
        """
    ...
    def cancel_operation(self, name, retry=..., timeout=..., compression=..., metadata=...): # -> None:
    ...
    def delete_operation(self, name, retry=..., timeout=..., compression=..., metadata=...): # -> None:
