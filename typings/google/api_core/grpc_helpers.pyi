...
def wrap_errors(callable_): # -> _Wrapped[..., Any, ..., _StreamingResponseIterator[Any]] | _Wrapped[..., Any, ..., Any]:
...
class _CallableStub:
    ...
    def __call__(self, request, timeout=..., metadata=..., credentials=..., compression=...): # -> object:
        ...
