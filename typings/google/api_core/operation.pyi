...
class Operation(polling.PollingFuture):
    ...
    @classmethod
    def deserialize(self, payload): # -> Operation:
...
def from_grpc(operation, operations_stub, result_type, grpc_metadata=..., **kwargs): # -> Operation:
...
def from_gapic(operation, operations_client, result_type, grpc_metadata=..., **kwargs): # -> Operation:
