...
if TYPE_CHECKING:
    _P = ParamSpec("_P")
    _Y = TypeVar("_Y")
def retry_target_stream(target: Callable[_P, Iterable[_Y]], predicate: Callable[[Exception], bool], sleep_generator: Iterable[float], timeout: Optional[float] = ..., on_error: Optional[Callable[[Exception], None]] = ..., exception_factory: Callable[[List[Exception], RetryFailureReason, Optional[float]], Tuple[Exception, Optional[Exception]],] = ..., init_args: tuple = ..., init_kwargs: dict = ..., **kwargs) -> Generator[_Y, Any, None]:
