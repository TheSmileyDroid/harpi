...
class RegexBuilder:
    ...
    """
    def __init__(self, pattern_args, pattern_func, flags=...) -> None:
        ...
...
class PreProcessorRegex:
    ...
    """
    def __init__(self, search_args, search_func, repl, flags=...) -> None:
        ...
...
class PreProcessorSub:
    ...
    """
    def __init__(self, sub_pairs, ignore_case=...) -> None:
        ...
...
class Tokenizer:
    ...
    def run(self, text): # -> list[str | Any]:
        """Tokenize `text`.
